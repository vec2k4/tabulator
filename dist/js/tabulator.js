...
;(function (global, factory) {
	...
	Menu.prototype.initializeGroup = function (group) {
		...
		group.getElement().addEventListener("contextmenu", function (e) {
			var menu = typeof _this61.table.options.groupContextMenu == "function" ? _this61.table.options.groupContextMenu(group) : _this61.table.options.groupContextMenu;

			e.preventDefault();

			_this61.loadMenu(e, group, menu);
		});
	};
